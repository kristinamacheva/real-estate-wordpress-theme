<?php
/**
* Template Name: Search Property Page
*
* @package WordPress
            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <div class="row">
                    ...
                    if (isset($_GET['propType'])) {
                        if (!empty($_GET['propType'])) {
                            $args['tax_query'][] = [
                                ...
                                'field' => 'name',
                                'terms' => array(sanitize_text_field($_GET['propType'])),
                            ];
                        }
                    }
                    ...
                    <div class="alert alert-danger">
                        Няма имоти, които да отговарят на вашите критерии за търсене!
                    </div>     
                    <?php endif;?>
                    <?php endif;?>
                </div>
